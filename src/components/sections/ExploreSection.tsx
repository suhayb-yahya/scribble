    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-[68vh] md:min-h-[72vh]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-end items-center md:items-start w-full px-0">
          <div className="w-full max-w-[520px] text-left mt-24 md:mt-44">
            <h2
              className={`${rubik.className} uppercase tracking-[0.04em] mb-4`}
              style={{
                color: '#FFF',
                fontSize: '53.294px',
                fontStyle: 'normal',
            ...
            <p
              className={`${rubik.className} max-w-[420px] mb-10`}
              style={{
                color: '#FFF',
                fontSize: '20px',
                fontStyle: 'normal',
        ...
        <div className="max-w-6xl mx-auto w-full flex mt-10 md:mt-12 overflow-visible -mr-6 md:-mr-10">
          ...
          <div className="flex-[0_0_auto] w-[703.317px] h-[128.258px] rounded-l-[4rem] md:rounded-l-[5rem] rounded-r-none border-t border-l border-b border-white pl-6 pr-0 py-0 bg-black/20 backdrop-blur-sm flex items-stretch gap-0 relative overflow-hidden">
            <div className="flex items-center gap-6 md:gap-8 flex-1 py-4 pl-0 pr-6">
              <div className="flex flex-col justify-center">
                <span className="block w-[95.62px] h-[57.38px] shrink-0" aria-hidden>
                  <svg xmlns="http://www.w3.org/2000/svg" width="95.62" height="57.38" viewBox="0 0 123 50" fill="none" className="w-full h-full">
            ...
            <button
              type="button"
              className="shrink-0 self-start flex items-center justify-center bg-white border-t border-r border-b border-white rounded-r-none hover:opacity-95 transition-opacity pl-4 pr-3 mr-8"
              style={{ width: '139.044px', height: '49.361px' }}
              aria-label="View portfolio"
            >
              <span
                className={`${rubik.className} uppercase whitespace-nowrap`}
                style={{
                  color: '#19140F',
                  fontSize: '19.181px',
                  fontStyle: 'normal',
