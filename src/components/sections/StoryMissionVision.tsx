  ...
  return (
    <section className="relative z-10 py-20 px-6 md:px-10 bg-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-12 ml-6 md:ml-[12%] lg:ml-[14rem]">
          <div>
            <h3 className={`${rubik.className} text-[2.25rem] font-semibold leading-normal uppercase text-primary mb-4`}>STORY</h3>
            <p className={`${rubik.className} text-[1.16rem] font-semibold leading-normal text-[#19140F]`}>
          ...
          <div>
            <h3 className={`${rubik.className} text-[2.25rem] font-semibold leading-normal uppercase text-primary mb-4`}>VISION</h3>
            <p className={`${rubik.className} text-[1.16rem] font-semibold leading-normal text-[#19140F]`}>
              In our graphic design work, we focus on delivering more than just beautiful visuals, we craft designs that communicate, inspire, and achieve real impact.
            </p>
          </div>
